      ...
      <nav className="flex-1 px-3 py-4 overflow-y-auto">
        ...
        <div className="space-y-0.5 mb-4">
          ...
          {hasModulo(modulosHabilitados, 'PAINEL_FISCAL') && (
            <NavLink href="/dashboard/fiscal" label="Painel do Fiscal" icon={
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        {(permissions.includes('ANVISA_RELATORIOS') ||
          ...
          permissions.includes('SUPER_ADMIN_GLOBAIS')) && (
          <>
            <p className="px-3 mb-1.5 mt-1 text-[10px] font-semibold uppercase tracking-wider text-slate-300">DSF</p>
            <div className="space-y-0.5 mb-3">
              {permissions.includes('ANVISA_RELATORIOS') && (
